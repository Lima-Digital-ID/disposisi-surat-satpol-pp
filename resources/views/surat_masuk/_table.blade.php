      ...
      <tbody>
          ...
          {{-- @if (auth()->user()->id == $item->id_pengirim || auth()->user()->level == 'Administrator' || auth()->user()->level == 'Admin' || auth()->user()->level == 'Kasat') --}}
              <tr class="border-bottom-primary">
                ...
                <td>{{ $item->perihal }}</td>
                <td align="center"><a href="{{ "upload/surat_masuk/".$item->file_surat }}" target="_blank" class="btn btn-info btn-sm mr-2"><i class="fa fa-file"></i></a></td>
                <td>
                    <div class="form-inline">
                        ...
                        <a href="#" class="mr-2">
                            <button type="button" id="PopoverCustomT-1" class="btn btn-warning btn-sm"
                                data-toggle="tooltip" title="Disposisi" data-placement="top"><span
                                    class="feather icon-mail"></span></button>
                        </a>
